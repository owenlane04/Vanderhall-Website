...
export const PRODUCTION_BLOCKERS = Object.freeze([
  ...
  { id: "reservation-status-hookup", owner: "John", detail: "The two reservation status pages render one fictional customer and two fictional reservations. Six contracts are missing: the tokenized read that resolves a link to a customer and their reservations, the four writes behind Update contact, Confirm selection, Assign or confirm dealer, and Update payment color, and the public lookup at /reservation-status/ that mails a customer their link. The lookup MUST answer identically whether or not the address matches a reservation, or it becomes a public oracle for who holds one. FORM_ENDPOINTS['reservation-lookup'], ['reservation-contact'], ['reservation-selection'], ['reservation-dealer'] and ['reservation-payment'] are all null." },
